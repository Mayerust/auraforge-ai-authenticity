"""
AURAFORGE — Demo Training Script
Generates synthetic audio files so you can train + test without
downloading real datasets first.

Usage:
    python train_demo.py

This creates data/ai/ and data/human/ with 40 synthetic WAV files each,
then trains the model and saves model.pkl.

For production accuracy: replace synthetic data with real Suno/GTZAN audio.
"""
...
if __name__ == "__main__":
    ...
    print("\n✅  model.pkl saved — run: uvicorn main:app --reload")
